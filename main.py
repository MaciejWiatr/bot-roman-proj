...
class Bot(Client):
    ...
    def __init__(self, email, password):
        ...
        self.help_text = {
            'wiki': "Wiki function search for wikipedia definition of given keyword",

            'dance': "dance command send gif of dancing rockalone2, you can specify the type of dance by using 'def' or 'alter' keyword after !dance command",

            'weeb': "weeb command displays gif containing anime girl, you can specify level of your 'weebnes' by using 'nsfw' keyword after !weeb ",

            'zmiany': "zmiany function changes overall look of chat",

            'change': "change function changes the overall look of chat ",

            'zadyma': "list of zadymiarnia commands: \n1. Head\n2. Szef\n3. Rafon\n4. Blowjob",
